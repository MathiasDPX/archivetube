...
ArchiveTube supports <a href="https://dearrow.ajay.app/" target="_blank">Dearrow</a>, an open source extension for crowdsourcing better titles and thumbnails. Using Dearrow does not change current/future archived thumbnail and title but change the image returned by `/data/media/channels/channel-id/video-id/video.webp`
